...
public class GameGrid extends javax.swing.JFrame{
    ...
    public GameGrid(CustomizeBoard cus) {
        this.cus=cus;
        setRows=cus.getRows(); 
    ...
    public void GUI() {
       ...
       setMaximumSize(new java.awt.Dimension(2000, 2000));
        ...
        rollDiceButton.setBackground(new java.awt.Color(252,252,252));
        ...
        Restart.setBackground(new java.awt.Color(252,252,252));
  ...
  String random2 = Integer.toString(random); 
   diceString.setFont(new java.awt.Font("Tahoma", 0, 16));  
   diceString.setText("Dice No: " + random2);
    ...
    private void scoreCardMenuItem(java.awt.event.ActionEvent evt) {
        menu.printHighScores(); 
        menu.setScoreCardFrameVisible(true); 
    }

    
    private void exitMenuItem(java.awt.event.ActionEvent evt) {
        System.exit(0); 
